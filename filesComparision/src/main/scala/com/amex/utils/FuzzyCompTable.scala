package main.scala.com.amex.utils
  ...
  object FuzzyCompTable {
    ...
    def main(args: Array[String]): Unit = {
      ...
      val TableName1:String = "FileComparision.filecomaprision"+currentTimestamp+"_a"
      val TableName2:String = "FileComparision.filecomaprision"+currentTimestamp+"_b"
      ...
      val createStmntFile = new File(s"${file}/createFile.sql")
      ...
      if (createStmntFile.exists)
        createStmntFile.delete()


      val bw = new BufferedWriter(new FileWriter(outFile))
      val bw1 = new BufferedWriter(new FileWriter(createStmntFile))
       ...
       */
          ...
          arbtHBaseFileDF1.write.saveAsTable(TableName1)
          arbtHBaseFileDF2.write.saveAsTable(TableName2)
          ...
          if(ColumnList.contains(keyColumn)){
             ...
             */
              ...
              val fromStmnt: String = s" from ${TableName1} a join ${TableName2} b on " + KeyColumnCondition
