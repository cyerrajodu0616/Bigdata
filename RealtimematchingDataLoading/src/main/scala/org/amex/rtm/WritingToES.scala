...
object WritingToES {
  ...
  def main(args: Array[String]): Unit = {
    ...
    case class IndexColumns1(name: String, businessId: String,recid: String,vendorname: String,state: String,zip: String,phone: String,hashraw: String,listcode: String,addrtype: String,rectype: String,busname: String,matchtype: String,masterid: String,completeRec: String)
   ...
   // conf.set("es.resource","realtimematching")
    ...
    val readData = sc.textFile(inputfolder).
                      map(x => (x.split("\u0001")(0).split("~"),x.split("\u0001").drop(1).mkString("\u0001")))

    val EsData = readData.map(f => IndexColumns1(f._1(0),f._1(1),f._1(2),f._1(3),f._1(4),f._1(5),f._1(6),f._1(7),f._1(8),f._1(9),f._1(10),f._1(11),f._1(12),f._1(13),f._2))
